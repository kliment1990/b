...
import PentHouseImg from "../../../images/Houses/Eighty Seven Park Penthouse Family Room.webp"
import styled from "styled-components";
import {FaHouseUser, FaBed, FaBath} from "react-icons/fa"
import PentHouse from "../../../images/Houses/Eighty Seven Park Penthouse Family Room.webp";
...
const Houses = () => {
    return (
        <div className="col-sm-12 col-md-6 flex-column">
                    ...
                    houseData.map(item => {
                        ...
                        return <div className="card mb-3 ">
                            ...
                            <div className={"container"}>
                                <div className={"row"}>
                                        <p className="col-4">{about}</p>
                                            <p className={"col-4"}>{data.map(dt => {
                                                return <Div>
                                                    <P>{dt.picture}</P>
